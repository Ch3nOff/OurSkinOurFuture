export const GARMENT_CATALOG = [
  ...
  },
  {
    ...
    undertones: ["cool", "warm", "neutral"],
    bestFor: ["dryness", "sensitivity", "redness"],
    reason: "Soft ivory brightens the face without competing with undertones.",
  },
  {
    id: "burgundy-cotton-tee",
    name: "Burgundy Cotton Tee",
    color: "#800020",
    colorName: "Burgundy",
    category: "tops",
    ...
    undertones: ["cool", "warm"],
    bestFor: ["dullness", "uneven_tone"],
    reason: "Deep burgundy adds richness and works with both warm and cool undertones.",
  },
  {
    id: "sage-green-oxford",
    name: "Sage Green Oxford",
    color: "#9DC183",
    colorName: "Sage Green",
    category: "tops",
    imageUrl: "https://images.unsplash.com/photo-1593030761757-71fae45fa0e7?w=400&h=500&fit=crop",
    undertones: ["cool", "neutral"],
    bestFor: ["redness", "oiliness"],
    reason: "Muted sage reduces visual redness and feels fresh on warm days.",
  },
  {
    ...
    undertones: ["warm", "neutral"],
    bestFor: ["dryness", "sensitivity"],
    reason: "Warm cream adds softness and pairs well with golden undertones.",
  },
];
